function ProgressDialog(imageUI) {
    ...
    var uploadAll = $("<button class='upload_button'>Upload All Files</buttom>");
    var cancelAll = $("<button class='upload_button'>Cancel All Files</buttom>");
    var closeProgress = $("<button class='upload_button'>Close Progress Dialog</buttom>");
